...
public interface IDeviceSelectionMatrixService {
	...
	JsonObject getVendorMarketShare(String marketid);
	
	//Asheet - 12/7
	JsonObject getUserVendorMarketShare(String marketid);
	JsonObject getBrowserVendorMarketShare(String marketid);
	...
	JsonObject getOsMarketShare(String marketid);
	
	//Asheet - 12/7
	JsonObject getUserOsMarketShare(String marketid);
	JsonObject getBrowserOsMarketShare(String marketid);
	...
	///PROJECTS
			...
			JsonObject getBrowserMarketShare(String marketid);

			JsonObject getBrowserMarketShareMobile(String marketid);

			boolean addBrowserMarketTrend(String market, String filePath, String type);
