...
public class BrowserVendorMarketTrend implements Comparable<BrowserVendorMarketTrend>{
	...
	public BrowserVendorMarketTrend() {
		super();
	}

	public BrowserVendorMarketTrend(String oemdistributionid, String marketid,
	...
	@Override
	public int compareTo(BrowserVendorMarketTrend arg0) {
		 Date date1 = null;
		 Date date2 = null;
		try {
