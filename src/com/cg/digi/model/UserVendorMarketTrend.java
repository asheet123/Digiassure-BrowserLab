...
public class UserVendorMarketTrend implements Comparable<UserVendorMarketTrend>{
	...
	public UserVendorMarketTrend() {
		super();
	}

	public UserVendorMarketTrend(String oemdistributionid, String marketid,
	...
	@Override
	public int compareTo(UserVendorMarketTrend arg0) {
		 Date date1 = null;
		 Date date2 = null;
		try {
