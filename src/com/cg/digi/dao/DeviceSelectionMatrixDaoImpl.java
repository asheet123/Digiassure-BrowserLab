...
public class DeviceSelectionMatrixDaoImpl implements IDeviceSelectionMatrixDao {
	...
	public List<UserMarket> getUserMarkets() {
		String query = "SELECT * FROM  mobilelab.usermarket WHERE status= 'Y'";
		List<UserMarket> markets = null;
		try {
			markets = jdbcTemplate.query(query, new BeanPropertyRowMapper(UserMarket.class));
			DigiLoggerUtils.log("UserMarket details in Dao  : " + markets, LEVEL.trace);
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getUserMarkets() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getUserMarkets() :: " + e, LEVEL.error);
		}
		return markets;
	}
	@SuppressWarnings({ "rawtypes", "unchecked" })
	...
	public List<BrowserMarket> getBrowserMarkets() {
		String query = "SELECT * FROM  mobilelab.browsermarket WHERE status= 'Y'";
		List<BrowserMarket> markets = null;
		try {
			markets = jdbcTemplate.query(query, new BeanPropertyRowMapper(BrowserMarket.class));
			DigiLoggerUtils.log("BrowserMarket details in Dao  : " + markets, LEVEL.trace);
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserMarkets() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getBrowserMarkets() :: " + e, LEVEL.error);
		}
		return markets;
	}
	...
	public List<DeviceCatalog> getDevices() {
		String query = "SELECT device_catalog.devicecatalogid,device_catalog.devicename,device_catalog.model,device_catalog.os,device_catalog.version,device_catalog.launchdate,device_catalog.resolution,device_catalog.devicetype,device_catalog.vendor,device_catalog.manufacturer,device_catalog.status,device_catalog.vendordeviceid,device_catalog.availability,device_catalog.imei,device_catalog.simno,CASE WHEN  device_catalog.belongsto is  null THEN 'None' WHEN  device_catalog.belongsto =0 THEN 'None' WHEN device_catalog.belongsto is not null THEN (select projectname from digiassure.project, mobilelab.device_catalog where  device_catalog.belongsto=project.projectid) END as belongsto,device_catalog.location,device_catalog.browsers,device_catalog.connectivity,device_catalog.remarks,device_catalog.procurementdate \r\n" + 
				"FROM mobilelab.device_catalog where device_catalog.status='Y' ;";
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<UserVendorMarketTrend> getUserVendorMarketShare(String marketid) {

		String query = "Select * from mobilelab.uservendormarkettrends where marketid="
				+ marketid +" and status='Y'";
		List<UserVendorMarketTrend> vendorMarketTrends = null;
		try {
			vendorMarketTrends = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(UserVendorMarketTrend.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getUserVendorMarketShare() :: "
					+ e, LEVEL.error);
		}
		return vendorMarketTrends;
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<BrowserVendorMarketTrend> getBrowserVendorMarketShare(String marketid) {

		String query = "Select * from mobilelab.browservendormarkettrends where marketid="
				+ marketid +" and status='Y'";
		List<BrowserVendorMarketTrend> vendorMarketTrends = null;
		try {
			vendorMarketTrends = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(BrowserVendorMarketTrend.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserVendorMarketShare() :: "
					+ e, LEVEL.error);
		}
		return vendorMarketTrends;
	...
	//Asheet - 12/7
	@Override
	public UserMarket getUserMarket(String marketid) {

		String query = "Select * from mobilelab.usermarket where marketid="
				+ marketid;
		UserMarket market = null;
		try {
			market = jdbcTemplate.queryForObject(query,
					new BeanPropertyRowMapper<UserMarket>(UserMarket.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getUserMarket() :: " + e,
					LEVEL.error);
		}
		return market;
	}
	@Override
	public BrowserMarket getBrowserMarket(String marketid) {

		String query = "Select * from mobilelab.browsermarket where marketid="
				+ marketid;
		BrowserMarket market = null;
		try {
			market = jdbcTemplate.queryForObject(query,
					new BeanPropertyRowMapper<BrowserMarket>(BrowserMarket.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserMarket() :: " + e,
					LEVEL.error);
		}
		return market;
	}
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<UserVendorMarketTrend> getUserOsMarketShare(String marketid) {

		String query = "Select osmarkettrendsid as oemdistributionid,marketid,os as vendorname,month,value,status,creationtime,createdby,modifiedby,modifiedtime from mobilelab.userosmarkettrends where marketid="
				+ marketid+" and status='Y'";
		List<UserVendorMarketTrend> vendorMarketTrends = null;
		try {
			vendorMarketTrends = jdbcTemplate.query(query,
			...
			DigiLoggerUtils.log("DataAccessException in getUserOsMarketShare() :: "
					+ e, LEVEL.error);
		}
		return vendorMarketTrends;
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<BrowserVendorMarketTrend> getBrowserOsMarketShare(String marketid) {

		String query = "Select osmarkettrendsid as oemdistributionid,marketid,os as vendorname,month,value,status,creationtime,createdby,modifiedby,modifiedtime from mobilelab.browserosmarkettrends where marketid="
				+ marketid+" and status='Y'";
		List<BrowserVendorMarketTrend> vendorMarketTrends = null;
		try {
			vendorMarketTrends = jdbcTemplate.query(query,
			...
			DigiLoggerUtils.log("DataAccessException in getBrowserOsMarketShare() :: "
					+ e, LEVEL.error);
		}
		return vendorMarketTrends;
	...
	public List<UserOsDistribution> getUserOsDistribution(String osid) {
		...
		String query = "Select * FROM mobilelab.userosdistributiondetails where osid="
				+ osid;
		List<UserOsDistribution> osDistributions = null;
		try {
			osDistributions = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(UserOsDistribution.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getUserOsDistribution() :: "
					+ e, LEVEL.error);
		}
		return osDistributions;
	...
	public List<BrowserOsDistribution> getBrowserOsDistribution(String osid) {
		...
		String query = "Select * FROM mobilelab.browserosdistributiondetails where osid="
				+ osid;
		List<BrowserOsDistribution> osDistributions = null;
		try {
			osDistributions = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(BrowserOsDistribution.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserOsDistribution() :: "
					+ e, LEVEL.error);
		}
		return osDistributions;
	...
	public UserOsDetails getUserOsDetails(String osName) {
		String query = "SELECT * FROM  mobilelab.userosdetails WHERE osname='" + osName
				+ "' and status='Y'";
		UserOsDetails osDetails = null;
		try {
			osDetails = jdbcTemplate.queryForObject(query, new BeanPropertyRowMapper<>(UserOsDetails.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getUserOsDetails() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getUserOsDetails() :: " + e, LEVEL.error);
		}
		return osDetails;
	...
	public BrowserOsDetails getBrowserOsDetails(String osName) {
		String query = "SELECT * FROM  mobilelab.browserosdetails WHERE osname='" + osName
				+ "' and status='Y'";
		BrowserOsDetails osDetails = null;
		try {
			osDetails = jdbcTemplate.queryForObject(query, new BeanPropertyRowMapper<>(BrowserOsDetails.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserOsDetails() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getBrowserOsDetails() :: " + e, LEVEL.error);
		}
		return osDetails;
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<BrowserMarketTrend> getBrowserMarketShare(String marketid) {

		String query = "Select * from mobilelab.browsermarkettrends where marketid="
				+ marketid +" and status='Y'";
		List<BrowserMarketTrend> browserMarketTrends = null;
		try {
			browserMarketTrends = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(BrowserMarketTrend.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowserMarketShare() :: "
					+ e, LEVEL.error);
		}
		return browserMarketTrends;

	}
	
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Override
	public List<BrowserMarketTrend> getBrowserMarketShareMobile(String marketid) {

		String query = "Select mobilebrowsermarkettrendsid as browserdistributionid,marketid,browser as browsername,month,value,status,creationtime,createdby,modifiedby,modifiedtime from mobilelab.mobilebrowsermarkettrends where marketid="
				+ marketid+" and status='Y'";
		List<BrowserMarketTrend> mobileBrowserMarketTrends = null;
		try {
			mobileBrowserMarketTrends = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(BrowserMarketTrend.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getOsMarketShare() :: "
					+ e, LEVEL.error);
		}
		return mobileBrowserMarketTrends;

	}
	
	@Override
	public boolean addMarketBrowserData(BrowserMarketTrend browserMarketTrend) {
		int result = 0;
		String query = "INSERT INTO mobilelab.browsermarkettrends(marketid,browsername,month,value,status,creationtime,createdby)VALUES(?,?,?,?,?,current_time,?)";
		Object[] params = new Object[] { browserMarketTrend.getMarketid(),
				browserMarketTrend.getBrowsername(), browserMarketTrend.getMonth(),
				browserMarketTrend.getValue(), browserMarketTrend.getStatus(), 1 };
		try {
			result = jdbcTemplate.update(query, params);
		} catch (DataAccessException e) {
			DigiLoggerUtils.log(
					"Error addMarketBrowserData Dao :: "
							+ e.getMessage(), LEVEL.error);
		}
	...
	@Override
	public boolean addMarketMobileBrowserData(BrowserMarketTrend browsermarketTrend) {
		int result = 0;
		String query = "INSERT INTO mobilelab.mobilebrowsermarkettrends(marketid,browser,month,value,status,creationtime,createdby)VALUES(?,?,?,?,?,current_time,?)";
		Object[] params = new Object[] { browsermarketTrend.getMarketid(),
				browsermarketTrend.getBrowsername(), browsermarketTrend.getMonth(),
				browsermarketTrend.getValue(), browsermarketTrend.getStatus(), 1 };
		try {
			...
			DigiLoggerUtils.log(
					"Error addMarketMobileBrowserData Dao :: "
							+ e.getMessage(), LEVEL.error);
		}
...
//Add and remove  methods
	@Override
	public boolean updateMarketBrowserData(String status, String marketId) {
		int result = 0;
		String query = "UPDATE mobilelab.browsermarkettrends SET status=? where marketid=?";
		try {
			Object[] params = new Object[] { status, marketId };
			result = jdbcTemplate.update(query, params);

		} catch (DataAccessException e) {
			DigiLoggerUtils.log("Error updateMarketBrowserData( String status, String marketId) Dao :: " + e.getMessage(),
					LEVEL.error);
	...
	public boolean removeMarketBrowserOldData(String market) {
		int result = 0;
		String query = "DELETE FROM mobilelab.browsermarkettrends WHERE status='N' AND marketid='"+market+"'";
		try {
			result = jdbcTemplate.update(query);

		} catch (DataAccessException e) {
			DigiLoggerUtils.log("Error removeMarketBrowserOldData(String market) Dao :: " + e.getMessage(),
					LEVEL.error);
	...
	@Override
	public boolean updateMarketMobileBrowserStatus(String status, String marketid) {
		int result = 0;
		String query = "UPDATE mobilelab.mobilebrowsermarkettrends SET status=? where marketid=?";
		try {
			Object[] params = new Object[] { status, marketid };
			result = jdbcTemplate.update(query, params);

		} catch (DataAccessException e) {
			DigiLoggerUtils.log("Error updateMarketMobileBrowserStatus( String status, String marketId) Dao :: " + e.getMessage(),
					LEVEL.error);
	...
	public boolean removeMarketMobileBrowserOldData(String market) {
		int result = 0;
		String query = "DELETE FROM mobilelab.mobilebrowsermarkettrends WHERE status='N' AND marketid='"+market+"'";
		try {
			result = jdbcTemplate.update(query);

		} catch (DataAccessException e) {
			DigiLoggerUtils.log("Error removeMarketMobileBrowserOldData(String market) Dao :: " + e.getMessage(),
					LEVEL.error);
	...
	public WindowsDetails getWindowsDetails(String windowsName) {
		String query = "SELECT * FROM  mobilelab.windowsdetails WHERE windowsname='" + windowsName
				+ "' and status='Y'";
		WindowsDetails windowsDetails = null;
		try {
			windowsDetails = jdbcTemplate.queryForObject(query, new BeanPropertyRowMapper<>(WindowsDetails.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getWindowsDetails() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getWindowsDetails() :: " + e, LEVEL.error);
		}
	...
	public List<WindowsDistribution> getWindowsDistribution(String windowsid, String market) {
		...
		String query = "Select * FROM mobilelab.windowsdistributiondetails where windowsid='"
				+ windowsid+"' and marketid='"+market+"'";
		List<WindowsDistribution> windowsDistributions = null;
		try {
			windowsDistributions = jdbcTemplate.query(query,
					new BeanPropertyRowMapper(WindowsDistribution.class));
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getWindowsDistribution() :: "
					+ e, LEVEL.error);
		}
	...
	public List<BrowserCatalog> getBrowser(String market, String count) {
		String query = "SELECT * FROM mobilelab.browser_catalog where marketid='"+market+"'";
		List<BrowserCatalog> browser = null;
		try {
			browser = jdbcTemplate.query(query, new BeanPropertyRowMapper(BrowserCatalog.class));
			DigiLoggerUtils.log("Browser in Dao  : " + browser, LEVEL.trace);
		} catch (DataAccessException e) {
			DigiLoggerUtils.log("DataAccessException in getBrowser() :: " + e, LEVEL.error);
		} catch (Exception e) {
			DigiLoggerUtils.log("Exception in getBrowser() :: " + e, LEVEL.error, DeviceSelectionMatrixDaoImpl.class);
