						...
						<div class="dropdown-content dropdown-menu show marginLeft80px">
							<div>
								<ul class="list-unstyled">
									...
									<li>
										<a href="${pageContext.request.contextPath}/integratedQALabs/mobileLab/deviceSelectionMatrix/browserTrend?market=1" onclick="changeViewFromNav('browser')"><%-- <img src="${pageContext.request.contextPath}/styles/images/tooltip/mobileLab_tooltip.png" class="navImgResolution" /> --%> Browser Lab</a>
									</li>
									<li>
