...
<script src="${pageContext.request.contextPath}/vendor/angular-ui-router/rppiuelease/angular-ui-router.js"></script>
				...
				<li class="xn-openable"><a href="#"><span
					...
					<ul>
						<li><a href="#" onclick="changeViewFromNav('mobile')"><span
								class="fa fa-mobile"></span> Mobile Lab</a></li>
						<li><a href="${pageContext.request.contextPath}/integratedQALabs/mobileLab/deviceSelectionMatrix/browserTrend?market=1" onclick="changeViewFromNav('browser')"><span
								class="fa fa-desktop"></span> Browser Lab</a></li>
