		...
		<ul class="nav nav-tabs marginLeft15px marginTop15px" >
			...
			<li  class="active dropdown">
				...
				<li ><a
					...
					<li><a
						href="../../integratedQALabs/mobileLab/deviceSelectionMatrix/browserTrend?market=3">US</a></li>
					<!-- <li><a
			...
			<li>
				...
				<form name="userForm" method="post" class="pull-left"
								action="../../mobileLab/deviceSelectionMatrix/updateBrowserData"
								enctype="multipart/form-data">
								<label>Desktop: &nbsp <input type="radio" value="desktop" name="type" required="required"></label> &nbsp &nbsp
									<label>Mobile: &nbsp <input type="radio" value="mobile" name="type"></label>
