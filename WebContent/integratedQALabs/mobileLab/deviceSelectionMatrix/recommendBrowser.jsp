  ...
  $
	.ajax({
		...
		success : function(data) {
			document.getElementById("message").innerHTML="Device Reservation Successful..!"
...
<title>Browser Recommendation</title>
</head>
	...
	<div>
		...
		<ul class="nav nav-tabs marginLeft15px marginTop15px">
			...
			<li class="active dropdown"><a
				class="dropdown-toggle buttonlink" data-toggle="dropdown"><b><button
							...
							Browser Recommendation<span class="caret"></span>
						</button></b></a>
				<ul class="dropdown-menu">
					<li><a
						href="../../mobileLab/deviceSelectionMatrix/recommendBrowser?market=GLOBAL&count=20">Global</a></li>
					<li><a
						href="../../mobileLab/deviceSelectionMatrix/recommendBrowser?market=US&count=20">US</a></li>
					<li><a
						href="../../mobileLab/deviceSelectionMatrix/recommendBrowser?market=UK&count=20">UK</a></li>
					<!-- <li><a
						href="../../mobileLab/deviceSelectionMatrix/recommendBrowser?market=Australia&count=20">Australia</a></li> -->
				</ul></li>
		...
		<div class="top-bar">
			...
			<div class="font24px txtCenter">
				<label>Browser Recommendation</label>
			</div>
		...
		<div class="row col-md-12">
			...
			<div class="col-sm-12">
				...
				<p id="txt"></p>
				<c:if test="${ not empty browserList }">
					...
					<div class="dataTables_length" id="myTable_length">
						<label> Show <select name="myTable_length"
							class="form-control" onchange="window.location.href=this.value">
								...
								<option value="./recommendBrowser?market=${market }&count=20">20</option>
								<option value="./recommendBrowser?market=${market }&count=50">50</option>
								<option value="./recommendBrowser?market=${market }&count=75">75</option>
								<option value="./recommendBrowser?market=${market }&count=100">100</option>
						</select> entries
						</label>
					</div>
					<table align="left" class="table table-striped table-hover "
						...
						<tbody>
							...
							<c:forEach items="${browserList}" var="browserDetail">
								...
								<tr>
									...
									<td align="left"><label> <c:out
												value="${browserDetail.browsername}" /></label></td>
									<td align="left"><c:out value="${browserDetail.os}" /></td>
									<td align="left"><c:out value="${browserDetail.version}" /></td>
									<td align="left"><c:out value="${browserDetail.devicetype}" /></td>
