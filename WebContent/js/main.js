...
function changeViewFromNav(param) {
	...
	if (param == 'mobile') {
		...
		window.location.href = a + '/integratedQALabs/mobileLab/deviceSelectionMatrix/browserTrend?market=1';
		$(document).ready(function() {
			$("#integratedQALabs").addClass("panel-collapse collapse in");
		});	
	} else if (param == 'documentTesting') {
		window.location.href = a + '/digitalQAService/digitalChannelTesting/documentTesting/documentTesting';
